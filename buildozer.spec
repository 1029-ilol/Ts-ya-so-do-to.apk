...
title = Dino game but better

# (str) Package name
package.name = dinogame

# (str) Package domain (needed for android/ios packaging)
package.domain = com.yusufisgreat.dino
...
# comma separated e.g. requirements = python3,pygame-ce
...
#
#   Environment variable overrides have priority over profile overrides.errides.